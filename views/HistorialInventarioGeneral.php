...
//$sql = 'SELECT p.id,p.nombre,p.unidad,sum(l.stock) as stock FROM producto as p left join lote as l on l.idProducto = p.id where p.estado = "Habilitado" group BY p.id,p.nombre,p.unidad';
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Historial de Inventario General</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
              <li class="breadcrumb-item"><a href="inventarioGeneral.php">Inventario General</a></li>
              <li class="breadcrumb-item active">Historial de Inventario General</li>
            </ol>
          </div>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<!--        MODAL         -->
  ...
  <script>
    ...
    function VerHistorial(id){
        ...
        $.ajax({
        url: '../clases/Cl_HistorialInventarioGeneral.php?op=filtrarHistorial',
        type: 'POST',
        data: {
                id:id
            }, 
    ...
    function BuscarHistorialInventarios(){
        ...
        $.ajax({
            url: '../clases/Cl_HistorialInventarioGeneral.php?op=BuscarHistorial',
            type: 'POST', 
            success: function(data) {
                $("#contenerdor_tabla").html('');
                $('#example1').DataTable().destroy();
