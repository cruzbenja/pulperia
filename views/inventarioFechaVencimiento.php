...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Inventario Por Lotes</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
              <li class="breadcrumb-item active">Inventario por Lotes</li>
            </ol>
          </div>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="headingOne">
              <button id="lblInventarioGeneral" class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                Apertura de inventario por Lote
              </button>
            </h2>
                ...
                <form role="form" method="post" >
                          <div class="box-body">
                            <div class="form-horizontal">  
                              ...
                              <div class="col-md-2">
                                  <label for="" class="form-label">Estado inventario en Bs.</label>
                                  <div class="input-group">
                                      <input type="text" class="form-control text-center" value ="0" id ="direfenciaInventarios" disabled>
                                  </div>                 
                              </div>     
  ...
  <div class="card">
            <div class="card-header">
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                  <a href="HistorialInventarioFecha.php" type="button" class="btn btn-secondary"><i class="fas fa-search"></i> Ver Historial de Inventarios de Lotes</a> 
                </div>
            </div>
              <!-- /.card-header -->
              <div class="card-body">
  ...
  <script>
    ...
    function actualizarStock(){
        ...
        var fechaInicio = $("#fechaInicio").val();
            $.ajax({                
                 url:'../clases/Cl_InventarioFechaVencimiento.php?op=actualizarStock',
                 type:'POST',
                 data:{
                      ...
                      if(resp == 1){
                        ...
                        location.reload();
                          ...
                          if(resp == 2){
                            Swal.fire(
                              'Error!',
                              'Ha ocurrido un error al hacer el cierre de inventario!',
                              'error'
                            ) 
                          }                                  
                      }
    ...
    function IngresarStock(){
       ...
       $.ajax({
        url: '../clases/Cl_InventarioFechaVencimiento.php?op=ingresarStock',
        type: 'POST', 
        data:{
            id:id,
            stock:stock
        ...
        success: function(data) {
                if(data == "1"){     
                    ...
                    $('#example1').load('inventarioFechaVencimiento.php #example1')
    ...
    function BuscarInventarioAperturado(){
        ...
        $.ajax({
        url: '../clases/Cl_InventarioFechaVencimiento.php?op=BuscarApertura',
        type: 'POST', 
        success: function(data) {
                ...
                if(data == "vacio"){      
                    ...
                    $("#lblInventarioGeneral").html('Cierre de inventario por Lote');
    ...
    function EstadoActualInventario(){
        
        $.ajax({
        url: '../clases/Cl_InventarioFechaVencimiento.php?op=estadoDelInventario',
        type: 'POST', 
        success: function(resp1) { 
                if(resp1 != "error"){      
                  $("#direfenciaInventarios").val(resp1);
                }   
                else{
                  alert('error al traer el estado actual del inventario');
                }                  
            }          
        })         
    }
    ...
    function filtrarProductos(){
        ...
        var fechaInicio = $("#fechaInicio").val();
        var diferenciaInventario = $("#direfenciaInventarios").val();
        ...
        $.ajax({
        url: '../clases/Cl_InventarioFechaVencimiento.php?op=filtrarProductos',
        type: 'POST',
        data: {
                fechaInicio: fechaInicio,
